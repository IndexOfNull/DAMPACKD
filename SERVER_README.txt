This is the manual installation package for DAMPACK'D v1.2. This should have all the patches necessary to run a DAMPACK'D 1.1 server or to install it without Twitch/MultiMC.
